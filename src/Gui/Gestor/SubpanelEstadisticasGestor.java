...
public class SubpanelEstadisticasGestor extends AbstractPanelGestor {
	...
	private JPanel crearSeccionMesesAño() {
		...
		JPanel cabecera = new JPanel(new FlowLayout(FlowLayout.LEFT, VentanaPrincipal.escalar(10), 0));
		...
		spinnerAño = new JSpinner(new SpinnerNumberModel(controlador.getAnioActual(), 2000, 2100, 1));
		spinnerAño.setFont(VentanaPrincipal.FUENTE_NORMAL);
		spinnerAño.setPreferredSize(new Dimension(VentanaPrincipal.escalar(80), VentanaPrincipal.escalar(30)));
		...
		panelMesesAño = new JPanel(new GridLayout(3, 4, VentanaPrincipal.escalar(10), VentanaPrincipal.escalar(10)));
		panelMesesAño.setBackground(VentanaPrincipal.COLOR_TARJETA);
		panelMesesAño.setBorder(javax.swing.BorderFactory.createEmptyBorder(VentanaPrincipal.escalar(10), 0, 0, 0));
		rellenarPanelMeses(panelMesesAño, controlador.getIngresosPorAño(controlador.getAnioActual()));
	...
	private JPanel crearSeccionRangoTotal() {
		...
		labelResultadoRango
				.setBorder(javax.swing.BorderFactory.createEmptyBorder(VentanaPrincipal.escalar(5), 0, 0, 0));
	...
	private JPanel crearPanelControlesRango() {
		...
		spinnerInicio.setPreferredSize(new Dimension(VentanaPrincipal.escalar(120), VentanaPrincipal.escalar(30)));
		...
		spinnerFin.setPreferredSize(new Dimension(VentanaPrincipal.escalar(120), VentanaPrincipal.escalar(30)));
	...
	private JPanel crearSeccionTop(String titulo, List<Cliente> clientes, String tipo) {
		...
		panelClientes.setBorder(javax.swing.BorderFactory.createEmptyBorder(VentanaPrincipal.escalar(10), 0, 0, 0));
		...
		if (clientes.isEmpty()) {
			...
			for (Cliente c : clientes) {
				...
				if (tipo.equals("compras")) {
					info = pos + ". " + c.getNickname() + " — " + c.contarPedidosCompletados() + " pedidos";
				} else if (tipo.equals("intercambios")) {
					info = pos + ". " + c.getNickname() + " — " + c.contarIntercambios() + " intercambios";
				}
	...
	private void rellenarPanelMeses(JPanel panel, double[] ingresos) {
		...
		for (int i = 0; i < 12; i++) {
			...
			tarjeta.setBorder(javax.swing.BorderFactory
					.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(VentanaPrincipal.COLOR_BORDE),
							javax.swing.BorderFactory.createEmptyBorder(VentanaPrincipal.escalar(8),
			...
			JLabel labelValor = new JLabel(String.format("%.2f EUR", ingresos[i]), SwingConstants.CENTER);
	...
	public void procesarConsultarRangoTasacion() {
		...
		labelResultadoTasacion.setText(
				"Ingresos por tasación del " + inicio + " al " + fin + ":  " + String.format("%.2f EUR", total));
	}
