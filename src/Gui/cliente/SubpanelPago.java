...
public class SubpanelPago extends AbstractPanelCliente {
	...
	/**
	 * Lee los campos y llama al controlador para pagar. Lo llama el controlador
	...
	/**
	 * Crea el panel central con resumen del pedido y formulario de pago. Idéntico a
	 * SubpanelPagoTasacion con campo fecha de caducidad incluido.
	 *
