 ...
 * AbstractPanelEmpleadoSection y SubpanelNotificaciones la extienden
 * para reutilizar el mismo estilo visual.
 *
...
public abstract class AbstractPanelSection extends JPanel {
    ...
    /**
     * Crea el panel base con scroll y título.
    ...
    protected GridBagConstraints gbcCampo(int y) {
        ...
        gbc.insets = new Insets(
            VentanaPrincipal.escalar(6), 0, VentanaPrincipal.escalar(6), 0);
        return gbc;
    }
    ...
    protected GridBagConstraints gbcBoton(int y) {
        ...
        gbc.weightx = 0;
        gbc.insets = new Insets(
            VentanaPrincipal.escalar(12), 0, VentanaPrincipal.escalar(6), 0);
        return gbc;
    }
    ...
    protected GridBagConstraints gbcFiltro(int x, int y) {
        ...
        gbc.gridy = y;
        gbc.insets = new Insets(
            VentanaPrincipal.escalar(6), VentanaPrincipal.escalar(6),
            VentanaPrincipal.escalar(6), VentanaPrincipal.escalar(6));
        gbc.fill = GridBagConstraints.HORIZONTAL;
    ...
    protected JButton crearBotonAccion(String texto) {
        ...
        boton.setPreferredSize(new Dimension(
            VentanaPrincipal.escalar(180), VentanaPrincipal.escalar(36)));
    ...
    protected boolean contieneTexto(String base, String buscado) {
        ...
        return base.toLowerCase(Locale.ROOT)
            .contains(buscado.toLowerCase(Locale.ROOT));
    }
