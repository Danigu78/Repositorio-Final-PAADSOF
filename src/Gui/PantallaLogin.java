 ...
 * Permite iniciar sesión como cliente, empleado o gestor,
 * y registrarse como nuevo cliente.
 * La pantalla se divide en dos zonas: izquierda con el logo (33%)
 * y derecha con el formulario (67%).
 * Todos los tamaños están escalados según el DPI de la pantalla
 * para que se vea igual en todos los ordenadores.
 *
 * @author CheckPoint
 * @version 1.0
 */
public class PantallaLogin extends JPanel {
    ...
    /**
     * Construye la interfaz dividida en panel izquierdo (logo)
     * y panel derecho (formulario) con proporción 33/67.
     */
    ...
    /**
     * Crea el panel izquierdo con fondo naranja oscuro, logo,
     * título y descripción de la tienda.
     * Todos los tamaños están escalados con VentanaPrincipal.escalar().
     *
    ...
    private JPanel crearPanelLogo() {
        ...
        // Separador naranja decorativo
        JSeparator sep = new JSeparator();
        sep.setForeground(VentanaPrincipal.COLOR_ACENTO);
        sep.setPreferredSize(new Dimension(VentanaPrincipal.escalar(200), VentanaPrincipal.escalar(2)));
        gbc.gridy = 3;
    ...
    /**
     * Crea el panel derecho con CardLayout para alternar
    ...
    /**
     * Crea el formulario de login con tipo de usuario, nickname,
     * contraseña y botones de acción.
     * Todos los márgenes están escalados.
     *
    ...
    /**
     * Crea el formulario de registro con nickname, contraseña y DNI.
     * Todos los márgenes están escalados.
     *
    ...
    private JPanel crearFormularioRegistro() {
        ...
        gbc.insets = new Insets(VentanaPrincipal.escalar(8), 0, VentanaPrincipal.escalar(4), 0);
        gbc.gridy = 6;
        panel.add(crearEtiqueta("DNI (ej: 12345678A)"), gbc);
     ...
     * Navega al panel correspondiente si tiene éxito.
     */
     ...
     * Si tiene éxito hace login automático.
     */
    ...
    /**
     * Crea un campo de texto con fondo blanco y texto negro.
     * El padding interno está escalado según el DPI.
     *
    ...
    /**
     * Crea un campo de contraseña con fondo blanco y texto negro.
     * El padding interno está escalado según el DPI.
     *
    ...
    /**
     * Crea un botón principal (naranja) o secundario (texto naranja sin fondo).
     * El padding interno está escalado según el DPI.
     *
