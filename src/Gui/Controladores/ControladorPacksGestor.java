...
/**
 * Controlador de la gestión de packs para el gestor. Usa un empleado interno
 * con todos los permisos para gestionar packs.
 *
 * @author Antonino
 * @version 1.0
 */
public class ControladorPacksGestor {
	...
	/**
	 * Constructor del controlador de packs. Busca un empleado con permisos de packs
	 * o crea uno interno.
	 *
	 ...
	 */
	public boolean crearPack(String nombre, String descripcion, String imagen, double precio, int stock,
