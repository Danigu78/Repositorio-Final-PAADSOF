...
public class ControladorSegundaMano implements ActionListener {
     ...
     */
    public ControladorSegundaMano(SubpanelSegundaMano vista,
            Cliente cliente) {
        this.vista = vista;
    ...
    /**
     * Devuelve todos los productos de segunda mano visibles
     * excluyendo los del propio cliente.
     * Los sin tasar no son visibles y no se incluyen.
     *
    ...
    public List<Producto2Mano> obtenerTodos() {
        ...
        for (Producto2Mano p : todos) {
            ...
            if (!p.getPropietario().getNickname().equals(
                    cliente.getNickname()))
                resultado.add(p);
        }
        return resultado;
    ...
    public List<Producto2Mano> filtrar(String nombre, double precioMin,
        ...
        for (Producto2Mano p : tienda.buscarSegundaManoFiltrado(filtro)) {
            if (!p.isVisible()) continue;
            if (cliente != null && p.getPropietario().getNickname()
                    .equals(cliente.getNickname())) continue;
     ...
     */
    public List<Producto2Mano> ordenarPorNombreAsc(
     ...
     * @return Lista ordenada
     */
    public List<Producto2Mano> ordenarPorNombreDesc(
            List<Producto2Mano> productos) {
        List<Producto2Mano> resultado = new ArrayList<>(productos);
        resultado.sort((a, b) ->
    ...
    /**
     * Ordena una lista por precio tasado menor a mayor.
     * Todos los productos tienen valoración
     *
     * @param productos La lista a ordenar
     * @return Lista ordenada
     */
    public List<Producto2Mano> ordenarPorPrecioAsc(
            List<Producto2Mano> productos) {
        List<Producto2Mano> resultado = new ArrayList<>(productos);
        resultado.sort((a, b) ->
            Double.compare(
                a.getValoracion().getPrecioTasacion(),
                b.getValoracion().getPrecioTasacion()));
        return resultado;
    }
     ...
     * @return Lista ordenada
     */
    public List<Producto2Mano> ordenarPorPrecioDesc(
            List<Producto2Mano> productos) {
        List<Producto2Mano> resultado = new ArrayList<>(productos);
        resultado.sort((a, b) ->
            Double.compare(
     ...
     * @return Lista ordenada
     */
    public List<Producto2Mano> ordenarPorEstadoDesc(
            List<Producto2Mano> productos) {
        List<Producto2Mano> resultado = new ArrayList<>(productos);
        resultado.sort((a, b) ->
            Integer.compare(
     ...
     * @return Lista ordenada
     */
    public List<Producto2Mano> ordenarPorEstadoAsc(
            List<Producto2Mano> productos) {
        List<Producto2Mano> resultado = new ArrayList<>(productos);
        resultado.sort((a, b) ->
            Integer.compare(
