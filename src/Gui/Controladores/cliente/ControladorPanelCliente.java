...
/**
 * Controlador del panel principal del cliente.
...
public class ControladorPanelCliente implements ActionListener {
    ...
    /**
     * Gestiona los clicks de las pestañas de la barra de navegación.
     * Muestra la sección, marca la pestaña activa y actualiza los datos.
     *
