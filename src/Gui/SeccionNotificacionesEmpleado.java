	...
	public class SeccionNotificacionesEmpleado extends AbstractPanelEmpleadoSection {
		...
		private void cargarNotificaciones() {
			...
			List<Notificacion> notificacionesOrdenadas = new ArrayList<>(notificaciones);
			notificacionesOrdenadas.sort(Comparator.comparing(Notificacion::getFechaEnvio,
					Comparator.nullsFirst(Comparator.naturalOrder())).reversed());

			for (Notificacion notificacion : notificacionesOrdenadas) {
		...
		private String crearTextoLista(Notificacion notificacion) {
			...
			String resumen = crearResumenMensaje(notificacion);

			return estado + "   |   " + tipo + "   |   " + fecha + "   |   " + resumen;
		}
