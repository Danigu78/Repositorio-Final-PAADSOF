...
import Gui.Controladores.ControladorSegundaMano;
import javax.swing.*;
 ...
 * Reutiliza el mismo estilo de tarjetas y filtros que SubpanelCatalogo.
 *
 * @author Daniel
 * @version 1.0
 */
public class SubpanelSegundaMano extends JPanel {
    ...
    private JPanel crearTarjeta(Producto2Mano producto) {
        ...
        botonVer.addActionListener(e ->
            JOptionPane.showMessageDialog(this,
                "Detalle de producto de segunda mano próximamente.",
