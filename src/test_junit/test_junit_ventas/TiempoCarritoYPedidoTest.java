...
public class TiempoCarritoYPedidoTest {
    ...
    private static class ProductoPrueba extends ProductoVenta {
        ...
        public ProductoPrueba(String nombre, String descripcion,
                String imagenRuta, double precio, int stock) {
    ...
    void carritoAnadirProductoYCalcularSubtotal() {
        Cliente cliente1 = new Cliente("ana1", "1234", "12345678A");
        ProductoVenta libro1 = new ProductoPrueba(
            "libro1", "libro normal", "img1", 10.0, 10);
    ...
    void carritoEliminarProducto() {
        Cliente cliente1 = new Cliente("ana1", "1234", "12345678A");
        ProductoVenta juego2 = new ProductoPrueba(
            "juego2", "juego normal", "img2", 25.0, 8);
    ...
    void carritoVaciarCarritoDevuelveStock() {
        ...
        ProductoVenta libro1 = new ProductoPrueba(
            "libro1", "libro normal", "img1", 10.0, 10);
        ProductoVenta juego2 = new ProductoPrueba(
            "juego2", "juego normal", "img2", 20.0, 5);
    ...
    void pedidoSeCreaBienDesdeCarrito() {
        ...
        ProductoVenta juego2 = new ProductoPrueba(
            "juego2", "juego normal", "img1", 30.0, 7);
    ...
    void pedidoContarUnidadesYPrecioDeProducto() {
        Cliente cliente1 = new Cliente("maria1", "1234", "11111111A");
        ProductoVenta libro1 = new ProductoPrueba(
            "libro1", "libro normal", "img1", 15.0, 10);
    ...
    void comprobadorRegistrarYObtenerCarrito() {
        ...
        ProductoVenta libro4 = new ProductoPrueba(
            "libro4", "libro normal", "img4", 12.0, 10);
        Carrito carrito = new Carrito(cliente1);
    ...
    void comprobadorRegistrarPedidoYVerPendientes() {
        ...
        assertEquals(1,
            comprobador.getPedidosPendientesDeUsuario(cliente1.getId()).size());
    }
    ...
    void comprobadorLimpiarCarritos() {
        ...
        ProductoVenta libro1 = new ProductoPrueba(
            "libro1", "desc", "img1", 10.0, 10);
        ProductoVenta juego2 = new ProductoPrueba(
            "juego2", "desc", "img2", 20.0, 10);
    ...
    void carritoGetTotalConRegaloDevuelveSubtotal() {
        Cliente cliente1 = new Cliente("ana2", "1234", "12345678B");
        ProductoVenta juego2 = new ProductoPrueba(
            "juego2", "desc", "img", 30.0, 10);
        ProductoVenta caja3 = new ProductoPrueba(
            "caja3", "desc", "img", 5.0, 4);

        Carrito carrito = new Carrito(cliente1);
        carrito.añadirProducto(juego2, 2);

        Regalo regalo1 = new Regalo("regalo1",
            LocalDateTime.now().minusDays(1),
            LocalDateTime.now().plusDays(1), 50.0, caja3);
    ...
    void pedidoSetDescuentoAplicadoMientrasEstaPendiente() {
        ...
        DescuentoVolumen descuento1 = new DescuentoVolumen("descuento1",
            LocalDateTime.now().minusDays(1),
