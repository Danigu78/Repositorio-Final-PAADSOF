...
/**
 * Excepción que se lanza cuando una línea de un fichero
 * no cumple el formato esperado.
 * 
 * Incluye información sobre la línea donde se ha producido el error
 * y su contenido para facilitar la depuración.
 */
public class FicheroFormatoInvalidoException extends CheckPointException {
    ...
    /**
     * Devuelve el mensaje completo de la excepción incluyendo
     * la línea y su número.
     *
