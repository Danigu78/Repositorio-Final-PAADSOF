...
/**
 * Excepción que se lanza cuando se intenta añadir un producto a un pack en el
...
public class ProductoYaEnPackException extends CheckPointException {
	...
	/**
	 * Construye la excepción con un mensaje por defecto. Indica que el producto ya
